...
RAYGUIAPI void GuiSetExclusive(Rectangle rect);
RAYGUIAPI void GuiClearExclusive(void);
...
RAYGUIAPI int GuiFileLabelButton(Rectangle bounds, const char *text);                                      // Label button control, returns true when clicked
...
void GuiSetExclusive(Rectangle rect)
{
    guiControlExclusiveMode = true;
    guiControlExclusiveRec = rect;
}
void GuiClearExclusive(void)
{
...
int GuiFileLabelButton(Rectangle bounds, const char *text)
{
    GuiState state = guiState;
    int result = 0;
